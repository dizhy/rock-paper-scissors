...
const pcChose = document.querySelector(".pc-chose").src;
const btnRock = document.querySelector(".btn-rock");
const btnPaper = document.querySelector(".btn-paper");
const btnScissors = document.querySelector(".btn-scissors");
const displayPlayer = document.querySelector(".display-player");
const displayPC = document.querySelector(".display-pc");
const btns = document.querySelectorAll(".btns>button");
const winner = document.querySelector(".wins");
const playerScoreElemet = document.querySelector(".player-score");
const pcScoreElemet = document.querySelector(".pc-score");
...
function createPlayer(src) {
  ...
  imgDiv.classList = "chose player-chose";
...
function createPC(src) {
  ...
  let imgDiv = document.createElement("img");
  imgDiv.classList = "chose pc-chose";
  imgDiv.src = `img/${src}.svg`;
